...
// VirtualFolder defines a mapping between an SFTPxy exposed virtual path and a
...
// path must exist. SFTPxy will, by default, try to automatically create any missing
