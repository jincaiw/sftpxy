...
// This is an hint for external auth plugins, is not used in SFTPxy directly
...
type BaseUserFilters struct {
	...
	// and virtual folders.
	// SFTPxy requires that the user's home directory, virtual folder root,
	...
	// It is ignored when using SFTPxy internal authentication
...
type BaseUser struct {
	...
	// For users created using SFTPxy REST API the password is be stored using bcrypt or argon2id hashing algo.
