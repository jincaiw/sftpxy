...
The `bulkuserupdate` example script shows how to use the SFTPxy REST API to easily update some common parameters for multiple users while preserving the others.
